...
smallImgs[0].addEventListener('mouseover', () => {
...
smallImgs[1].addEventListener('mouseover', () => {
...
smallImgs[2].addEventListener('mouseover', () => {
...
smallImgs[3].addEventListener('mouseover', () => {
...
smallImgs[4].addEventListener('mouseover', () => {
