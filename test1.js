window.addEventListener("load", event => {
    ...
    function productHeading() {
        ...
        const product = {
            value: 60,
            images: [
                { img: 'https://fsmerchtn.vercel.app/assets/images/logo%20mersh3.0.png' },
                { img: 'https://fsmerchtn.vercel.app/assets/images/logo%20mersh3.0.png' },
                { img: 'https://fsmerchtn.vercel.app/assets/images/logo%20mersh3.0.png' },
                { img: 'https://fsmerchtn.vercel.app/assets/images/logo%20mersh3.0.png' },
                { img: 'https://fsmerchtn.vercel.app/assets/images/logo%20mersh3.0.png' },
        ...
        function getDiscount() {
            priceOriginal.innerText = product.value + " DnT";
            discount = product.value - (product.value * (30 / 100));
            priceFinal.innerText = discount + " DnT";
        }

        // Calculate the Prices with discounts

        function getPrice() {
            priceFinal.innerText = discount * inputQuantity.value + " DnT";
            priceOriginal.innerText = product.value * inputQuantity.value + " DnT";
